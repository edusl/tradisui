...
;(function($) {
    $.pwstrength = function(password) {
        ...
        if(length < 4) score += 0; // TRADIS modified.
    ...
    $.fn.pwstrength = function(options) {
        var options = $.extend({
            label: '.label',
            classes: ['pw-bar--insecure', 'pw-bar--weak', 'pw-bar--medium', 'pw-bar--good', 'pw-bar--good'], // TRADIS modified.
            texts: ['Insegura', 'Débil', 'Media', 'Segura', 'Segura'] // TRADIS modified.
        }, options || {});
